...
<body class="page-template page-template-template page-template-template-page page-template-templatetemplate-page-php page page-id-692  transparent-no wpb-js-composer js-comp-ver-5.4.5 vc_responsive">
    ...
    <div style="position:fixed;width: 100%;z-index: 100;">
       ...
       <div id="floating-button" data-toggle="tooltip" data-placement="left" data-original-title="Create">
			<a href="https://wa.me/573152226222" target="_blank"><img src="images/WhatsApp-Logo.png" style="width: 70px" alt=""></a>
		  </div>
    <div  class="">
        ...
        <div class="header-media-wrap">
            <div class="header-media">
                <div class="header-media"><div id="myCarousel" class="carousel slide" data-ride="carousel">

                <!-- Wrapper for slides -->
                <div class="carousel-inner">
                    <div class="item active">
                    <img src="images/nosotros.jpg" alt="" style="width:100%;">
                    </div>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
              ...
              <div class="banner-caption">
                    ...
                    <h1 id="h1-title" style="text-transform:capitalize"><em>An</em>drea Monsalve</h1>
                </div>
            </div>
        </div>
    ...
    <section id="section-body">
        <div class="container">
            ...
            <!--<div class="page-title breadcrumb-top">
                <div class="row"  id="page-title-aling" id="figure-aling">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            <li><a itemprop="url" href="index.php"><span itemprop="title" style="color: #EC0100">Inicio</span></a></li>
                            <li><a itemprop="url" href="index.php"><span itemprop="title" style="color: #EC0100">Nosotros</span></a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-xs-12">
                                            <div class="profile-image">
                                                <img src="wp-content/uploads/2016/02/Andrea350.jpg" class="attachment-houzez-image350_350 size-houzez-image350_350 wp-post-image" alt="" style="width:350px; height:350px;">
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-8 col-xs-12">
                                            <div class="profile-description">
                                                <p class="p1 agent-title" style="text-transform:capitalize">Andrea Monsalve</p>
                                                <p class="p1 position">
                                                    Tutecho Inmobiliaria </p>
                                                <p>Asesor.</p>
                                                <ul class="profile-contact">
                                                    <li><span>Móvil:</span> <a href="tel:3112226222"  style="color:#000"><span class="clickToShow" style="display: none;">3112226222</span><span class="clickToShowButton">311-2226 222</span></a></li>
                                                    <li><span>Email:</span> <a href="mailto:amonsalve@tutecho.net"  style="color:#000">amonsalve@tutecho.net</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-12 col-xs-12">
                                            <div class="form-small">
                                                <p class="p1 agent-contact-title">Contáctame</p>
                                                <form method="post" action="" id="agent_detail_contact_form">
                                                    ...
                                                    <div class="form-group">
                                                        <input name="name" id="name" placeholder="Nombre" class="form-control" type="text">
                                                    </div>
                                                    <div class="form-group">
                                                        <input name="phone" id="phone" placeholder="Teléfono" class="form-control" type="text">
                                                    </div>
                                                    <div class="form-group">
                                                        <input name="email" id="email" placeholder="Correo electrónico" class="form-control" type="email">
                                                    </div>
                                                    <div class="form-group">
                                                        <textarea name="message" id="message" rows="3" class="form-control" placeholder="Mensaje"></textarea>
                                                    </div>
