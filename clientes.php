        ...
        <div class="header-media-wrap">
            <div class="header-media">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="images/26.jpg" alt="" style="width:100%;">
                    </div>

                    <div class="item">
                    <img src="images/IMG-20180314-WA0180.jpg" alt="" style="width:100%;">
                    </div>
                                                    ...
                                                    <div class="wpb_wrapper">
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                ...
                                                                <a href="#">
                                                                    <p><img class="aligncenter wp-image-153 size-medium" src="images/pago_propietarios.jpg" alt="Propietarios" sizes="(max-width: 300px) 100vw, 300px" width="300" height="300" style="height: 200px;"></p>
                                                                </a>
                                                                <h3 style="text-align: center;"><strong>Extracto propietarios</strong></h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="vc_column-inner ">
                                                    <div class="wpb_wrapper">
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                    <a href="#">
                                                                        <p><img class="aligncenter wp-image-153 size-medium" src="images/arrendatarios.jpg" alt="Propietarios" sizes="(max-width: 300px) 100vw, 300px" width="300" height="300"style="height: 200px;"></p>
                                                                    </a>
                                                                <h3 style="text-align: center;"><strong>Pago arrendatarios</strong></h3>
                                                ...
                                                <div class="vc_column-inner ">
                                                    <div class="wpb_wrapper">
                                                        <div class="wpb_text_column wpb_content_element ">
                                                            <div class="wpb_wrapper">
                                                                    <a href="#">
                                                                        <p><img class="aligncenter wp-image-153 size-medium" src="images/pse1.png" alt="Propietarios" sizes="(max-width: 300px) 100vw, 300px" width="300" height="300"></p>
                                                                    </a>
                                                                <h3 style="text-align: center;"><strong>Pagos PSE</strong></h3>
