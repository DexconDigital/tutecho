...
<body class="page-template page-template-template page-template-template-page page-template-templatetemplate-page-php page page-id-692  transparent-no wpb-js-composer js-comp-ver-5.4.5 vc_responsive">
                    ...
                    <div class="logo">
                        <h1>
                            <a class="navbar-brand" href="index.php">
                                <img src="images/tutecho1.png" class="img-responsive" id="tam-logo">
                            </a>
                        </h1>
                    </div>
                </div>
    ...
    <div id="floating-button" data-toggle="tooltip" data-placement="left" data-original-title="Create">
        <a href="https://wa.me/573152226222" target="_blank"><img src="images/whatsapp.svg" style="width: 50px" alt=""></a>
    </div>
    <div id="section-body p-0" class="">
        ...
        <div class="header-media-wrap">
            <div class="header-media">
                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="images/IMG-20180314-WA0222.jpg" alt="" style="width:100%;">
                        </div>
                    </div>
                ...
                <div class="container text-center">
                    <h1 id="" style="margin-top:10px;">
                        <em>Ca</em>tálogo virtual</h1>
                </div>
            </div>
        </div>
    ...
    <!--start compare panel-->
    <div class="agileit-services" style="margin-top: 60px;">
    ...
    <!--footer-->
    <footer class="agileits_w3layouts-footer" style ="margin-top: 1.5rem;">

    </footer>
    <!-- //footer -->
    <div class="agileits_w3layouts-search"></div>
