                ...
                <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                    <nav>
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="nosotros.html" class="hvr-bounce-to-bottom">Nosotros  |</a>
                            </li>
                            <li>
                                <a href="servicios.html" class="hvr-bounce-to-bottom">Servicios  |</a>
                            </li>
                            <li>
                                <a href="inmuebles.php" class="hvr-bounce-to-bottom">Inmuebles  |</a>
                            </li>
                            <li class="active">
                                <a href="clientes.html" class="hvr-bounce-to-bottom">Clientes  |</a>
                            </li>
                          
                        <li>
                            <a href="catalogo-virtual.html" class="hvr-bounce-to-bottom">Catálogo virtual  |</a>
                        </li>
                            <li>
                                <a href="contactenos.html" class="hvr-bounce-to-bottom">Contáctenos</a>
                            </li>
                            <li>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                ...
                <!--<div class="banner-caption">
                    ...
                    <h1 id="h1-title"><em>Pr</em>opietarios</h1>
                </div>-->
            </div>
        </div>
        ...
        <div class="container">
            ...
            <!--<div class="page-title breadcrumb-top">
                <div class="row">
                    <div class="col-sm-12">
                        <ol class="breadcrumb">
                            <li><a itemprop="url" href="index.html"><span itemprop="title" style="color: #EC0100">Inicio</span></a></li>
