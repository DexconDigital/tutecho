  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
               ...
               <div class="banner-caption">
                    ...
                    <h1 id="h1-title" style="text-transform:capitalize"><em>Je</em>nnifer Carolina Muñoz </h1>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-xs-12">
                                            <div class="profile-image">
                                                <img src="wp-content/uploads/2016/02/Jennifer350.jpg" class="attachment-houzez-image350_350 size-houzez-image350_350 wp-post-image" alt="" style="width:350px; height:350px;">
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-8 col-xs-12">
                                            <div class="profile-description">
                                                <p class="p1 agent-title" style="text-transform:capitalize">Jennifer Carolina Muñoz </p>
                                                <p class="p1 position">
                                                    Tutecho Inmobiliaria </p>
                                                <p>Asesor.</p>
                                                <ul class="profile-contact">
                                                    <li><span>Móvil:</span> <a href="tel:3152226222"  style="color:#000"><span class="clickToShow" style="display: none;">315 2226 222</span><span class="clickToShowButton">315-2226 222</span></a></li>
                                                    <li><span>Email:</span> <a href="mailto:jmunoz@tutecho.net"  style="color:#000">jmunoz@tutecho.net</a></li>
                                                </ul>
                                            </div>
                                        </div>
