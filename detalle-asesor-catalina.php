  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                ...
                <div class="banner-caption">
                   ...
                   <h1 id="h1-title" style="text-transform:capitalize"><em>Ca</em>talina Umaña</h1>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-4 col-xs-12">
                                            <div class="profile-image">
                                                <img src="wp-content/uploads/2016/02/user1-512.png" class="attachment-houzez-image350_350 size-houzez-image350_350 wp-post-image" alt="" style="width:350px; height:350px;">
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-8 col-xs-12">
                                            <div class="profile-description">
                                                <p class="p1 agent-title" style="text-transform:capitalize" >Catalina Umaña</p>
                                                <p class="p1 position">
                                                    Tutecho Inmobiliaria </p>
                                                <p>Jefe de Operaciones.</p>
                                                <ul class="profile-contact">
                                                    <li><span>Teléfono:</span> <a href="tel:6208801" style="color:#000"><span class="clickToShowPhone" style="display: none;">6208801</span><span class="clickToShowButtonPhone">6208801</span></a></li>
                                                    <li><span>Movil:</span> <a href="tel:3112003333" style="color:#000">3112003333</a></li>
                                                    <li><span>Email:</span> <a href="mailto:c.umana@tutecho.net" style="color:#000">c.umana@tutecho.net.</a></li>
                                                </ul>
                                            </div>
                                        </div>
