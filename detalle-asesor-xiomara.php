  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                ...
                <div class="banner-caption">
                    ...
                    <h1 id="h1-title" style="text-transform:capitalize"><em>Xi</em>omara Quiroga</h1>
                </div>
            </div>
        </div>
            ...
            <section class="section-detail-content houzez-page-template">
                <div>
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="profile-detail-block" id="figure-aling">
                                    <div class="row">
                                        <div class="col-sm-4 col-xs-12">
                                            <div class="profile-image">
                                                <img src="wp-content/uploads/2016/02/Xiomara.jpg" class="attachment-houzez-image350_350 size-houzez-image350_350 wp-post-image" alt="" sizes="(max-width: 350px) 100vw, 350px" style="width:350px; height:350px;">
                                            </div>
                                        </div>
                                        <div class="col-md-4 col-sm-8 col-xs-12">
                                            <div class="profile-description">
                                                <p class="p1 agent-title" style="text-transform:capitalize">Xiomara Quiroga</p>
                                                <p class="p1 position">
                                                ...
                                                <ul class="profile-contact">
                                                    ...
                                                    <li><span>Email:</span> <a href="mailto:operaciones@tutecho.net"  style="color:#000">operaciones@tutecho.net</a></li>
                                                </ul>
                                            </div>
                                        </div>
