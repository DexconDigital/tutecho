                ...
                <div class="logo">
                    <h1>
                        <a class="navbar-brand" href="index.php">
                           <img src="images/tutecho1.png" class="img-responsive" style="height: 32px;margin-top: 6px;"></a>
                    </h1>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                <nav>
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="asesores.php" class="hvr-bounce-to-bottom">Asesores  |</a>
                        </li>
                        <li>
                        ...
                        <li>
                        <a href="https://www.facebook.com/tutechonet-1182783751863330/" target="blank">
            ...
            <div class="header-media">
              <div class="header-media"><div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="images/clientes.jpg" alt="" style="width:100%;">
                    </div>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                ...
                <!--<div class="banner-caption">
                    ...
                    <h1 id="h1-title"><em>As</em>esores</h1>
                </div>-->
            </div>
        </div>
                        ...
                        <div class="row no-margin">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="agents-block">
                                    ...
                                    <figure class="auther-thumb">
                                        <a href="detalle-asesor.php" class="view">
                                                        <img src="wp-content/uploads/2016/02/agent-3-150x150.jpg" class="img-circle" alt="Samuel Palmer" width="150" height="150">
                                                            </a>
                                    </figure>
                                    ...
                                    <div class="block-body">
                                        <p class="auther-info">
                                            <span class="blue">Samuel Palmer</span><br>
                                        ...
                                        <a href="detalle-asesor.php" class="view">Ver Perfil</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="agents-block">
                                    ...
                                    <figure class="auther-thumb">
                                        <a href="detalle-asesor.php" class="view">
                                                        <img src="wp-content/uploads/2016/02/agent-4-150x150.jpg" class="img-circle" alt="Vincent Fuller" width="150" height="150">
                                                            </a>
                                    </figure>
                                    ...
                                    <div class="block-body">
                                        <p class="auther-info">
                                            <span class="blue">Vincent Fuller</span><br>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="agents-block">
                                    ...
                                    <figure class="auther-thumb">
                                        <a href="detalle-asesor.php" class="view">
                                                        <img src="wp-content/uploads/2016/02/agent-2-150x150.jpg" class="img-circle" alt="Brittany Watkins" width="150" height="150">
                                                            </a>
                                    </figure>
                                    ...
                                    <div class="block-body">
                                        <p class="auther-info">
                                            <span class="blue">Brittany Watkins</span><br>
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="agents-block">
                                    ...
                                    <figure class="auther-thumb">
                                        <a href="detalle-asesor.php" class="view">
                                                        <img src="wp-content/uploads/2016/02/agent-1-150x150.jpg" class="img-circle" alt="Michelle Ramirez" width="150" height="150">
                                                            </a>
                                    </figure>
                                    ...
                                    <div class="block-body">
                                        <p class="auther-info">
                                            <span class="blue">Michelle Ramirez</span><br>
