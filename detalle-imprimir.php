                                ...
                                <a class="right carousel-control" href="#myCarousel" data-slide="next" style="top:50%;">
                                    ...
                                    <span class="sr-only">Next</span>
                                                ...
                                                <div class="condtion-title">
                                                    <br>
                                                    <h5 id="code"> <a title="Arrastra este v��nculo a la barra de marcadores de tu navegador" href="javascript:window.print();" style="color: black;    margin-left: 20px;"><i class="fa fa-print fa-4x"></i></a></h5>
                                                    
                                                </div>
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="property-condition-list">
                                                                <i class="fa fa-price"></i><span id="precio"> </span>
                                                                <br>
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    <div class="property-condition-list">
                                                             <i class="fa fa-home"></i><span id="gestion"> </span>
                                                                <br>
                                    ...
                                    <div class="description-inner">
                                        <p class="text-1" style="color:#000"> <span id="descripcion"></span></p>
                                    </div>
                                </div>
                                 <br>
                                                     <div class="single-property-description">
                                                        <div class="desc-title">
                                                         <h5><em>Ca</em>racterisicas Internas</h5>
                                                                 </div>
                                                        <div class="description-inner">
                                                            <ul id="details-2"></ul>
                                                        </div>
                                                    ...
                                                    <div class="single-property-description">
                                                            <div class="desc-title">
                                                                <h5><em>Ca</em>racterisicas Externas</h5>
                                                             </div>
                                                        <div class="description-inner">
                                                            <ul id="details-1"></ul>
                                                        </div>
                ...
                success: function(data) {
                        ...
                        if (data.fotos == undefined) {
                            carrousel += '<div class="item active">' +
                                    '<img src="img/no_image.png" alt=""  id="tam-img"/><span class="marcaagua"><img src="images/marca_de_agua.png" /></span>'+
                                    '</div>';
                        } else {
                            carrousel += '<div class="item active">' +
                                    '<img src="' + data.fotos[0].foto + '" alt=""  id="tam-img"/><span class="marcaagua"><img src="images/marca_de_agua.png" /></span>'+
                                '</div>';

                            for (var y = 1; y < Object.keys(data.fotos).length - 1; y++) {
                                if (data.fotos[y].foto != undefined) {
                                    carrousel += '<div class="item">' +
                                    '<img src="' + data.fotos[y].foto + '" alt=""  id="tam-img"/><span class="marcaagua"><img src="images/marca_de_agua.png" /></span>'+
                                        '</div>';
                                    j++;
                                }
                            }
                    ...
                    $("#code").prepend("Codigo: "+ data.idInm);
                    ...
                    $("#tipo-gestion").append('<a title="'+data.Tipo_Inmueble+'"style="color: black;" >  '+data.Tipo_Inmueble+' en </a><a title="'+data.Gestion+'" style="color: black;" > '+data.Gestion+' </a>');
                    $("#gestion").html('<a title="'+data.Gestion+'" style="color:black"> '+data.Gestion+'</a>');
                      ...
                      var res = '';
                                if((data.caracteristicasExternas != undefined) ){
                                    for(var x = 0; x < Object.keys(data.caracteristicasExternas).length; x++){
                                            res+= '<li class="detalle-caracteristicas">'+data.caracteristicasExternas[x].Descripcion+'</li>';
                                    }
                                }
                    ...
                    var res1 = '';
                                    ...
                                    if(data.caracteristicasInternas != undefined || Object.keys(data.caracteristicasInternas).length > 0){
                                        for(var x = 0; x < Object.keys(data.caracteristicasInternas).length; x++){
                                                res1+= '<li class="detalle-caracteristicas">'+data.caracteristicasInternas[x].Descripcion+'</li>';
