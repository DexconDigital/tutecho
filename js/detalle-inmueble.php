...
<style id='houzez-style-inline-css' type='text/css'>
    ...
    <link rel="alternate" type="application/json+oembed"
        href="wp-json/oembed/1.0/embed-url=http_%7C%7Chouzez04.favethemes.com%7Cabout-houzez%7C.json" />
    <link rel="alternate" type="text/xml+oembed"
        href="wp-json/oembed/1.0/embed-url=http_%7C%7Chouzez04.favethemes.com%7Cabout-houzez%7C&format=xml.xml" />
    <script type="text/javascript">
    (function(url) {
...
<body
    class="page-template page-template-template page-template-template-page page-template-templatetemplate-page-php page page-id-692  transparent-no wpb-js-composer js-comp-ver-5.4.5 vc_responsive">
    <div id="preloader">
    </div>
    <div id="fb-root"></div>
                ...
                <div class="collapse navbar-collapse nav-wil" id="bs-example-navbar-collapse-1">
                    <nav>
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                <a href="https://www.facebook.com/Tutechonet-Inmobiliaria-278591092546718/"
                                    target="blank" style="font-size: 20px;">
                                    <i class="fa fa-facebook list-icon" aria-hidden="true" style="color: #3b5998;"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.instagram.com/tutecho.nett/" target="blank"
                                    style="font-size: 20px;">
                                    <i class="fa fa-instagram" aria-hidden="true" style="color: #8a3ab9;"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/channel/UCXNa6ec2ZrQW8HmhmeMNuEw" target="blank"
                                    style="font-size: 20px;">
    ...
    <div id="floating-button" data-toggle="tooltip" data-placement="left" data-original-title="Create">
        <a href="https://wa.me/573152226222" target="_blank"><img src="images/whatsapp.svg" style="width: 65px"
                alt=""></a>
    </div>
        ...
        <div class="container">
            ...
            <div id="compare-controller" class="compare-panel">
                <div class="compare-panel-header">
                    <h4 class="title"> Compare Listings <span class="panel-btn-close pull-right"><i
                                class="fa fa-times"></i></span></h4>
                </div>
                                                    ...
                                                    <div class="single-property-details">
                                                        <div class="carousel slide" id="myCarousel"
                                                            ...
                                                            <a class="left carousel-control" href="#myCarousel"
                                                                data-slide="prev" ">
                                                            <span class=" glyphicon fa fa-toggle-left"
                                                                aria-hidden="true" style="top: 50%"></span>
                                                                <span class="sr-only">Previous</span>
                                                            </a>
                                                            <a class="right carousel-control" href="#myCarousel"
                                                                data-slide="next">
                                                                <span class="glyphicon fa fa-toggle-right"
                                                                    aria-hiden="true" style="top:50%"></span>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <div class="single-property-description">
                                                                ...
                                                                <div class="description-inner text-justify">
                                                                    <p class="text-1" style="color:#000"> <span
                                                                            id="descripcion"></span></p><br>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <br>
            ...
            <div class="col-lg-4 col-lg-offset-1 col-md-offset-1 col-lg col-md-4 col-sm-6 col-sm-offset-1 col-xs-12">
                <div class="form-small">
                    ...
                    <form method="post" action="" id="agent_detail_contact_form">
                        ...
                        <input name="agent_detail_ajax_nonce" id="agent_detail_ajax_nonce" value="d20a4756b8"
                            type="hidden">
                    ...
                    <a href="https://simicrm.app/mcomercialweb/fichas_tecnicas/FichaInmueble.php?reg=<?php echo $codigo;?>"
                        target="_blank">
                        <button id="agent_detail_contact_btn" class="btn btn-secondary btn-block" type="submit"
                            style="margin-bottom: 10px;">Imprimir Ficha</button>
                    </a>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="contact-right-w3l">
                                    <div action="" method="post" id="contact_form" class="validate-form"
                                        onsubmit="enviardetalle()">
                                        <input class="name" name="name" id="name" placeholder="nombre de su amig@"
                                            required="" style="width:100%" type="text">
                                        <input class="name" name="name_envia" id="name_envia" placeholder="su nombre"
                                            required="" style="width:100%" type="text">
                                        <input class="name" name="email" id="email"
                                            placeholder="correo electrónico de su amig@" required="" style="width:100%"
                                            type="email">
                                        <textarea placeholder="mensaje para su amig@" name="message" id="message"
                                            required=""></textarea>
                                        <button class="btn btn-danger" type="submit" value="submit"
                                            id="sendMessageButton" onclick="enviardetalle()"
                                            style="width: 30%;height: 50px;font-size: 20px;border-radius: 10px;padding: 0;margin: 10px 0 0 0;">Enviar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCmu-UkTcheWni6_HMOKYU9x3AYP571e5s&callback=initMap"
        async defer></script>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.fotos == undefined) {
                    ...
                    for (var y = 0; y < Object.keys(data.fotos).length - 1; y++) {
