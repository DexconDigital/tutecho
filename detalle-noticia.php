        ...
        <div class="header-media-wrap">
            <div class="header-media">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="images/noticias.jpg" alt=""style="width:100%;">
                    </div>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                ...
                <div class="banner-caption">
                    ...
                    <h1 id="h1-title"> <em>De</em>talle noticia</h1>
                </div>
            </div>
        </div>
    ...
    <script>
        var imagen = 'http://biinyu.com.co/tutecho/v5/tutecho-noticias/admin/'+imagen+'';

        imagen = imagen.replace(/\s/g, '');

        var noticia =   '<div class="col-md-10 col-sm-6 col-xs-12" >'+
                        '<div class="page-main">'+
                        '<div class="white-block ">'+
                        '<article id="post-692" class="post-692 page type-page status-publish hentry">'+
                        '<div class="row row-fluid">'+
                        '<img src="'+imagen+'" alt="'+descripcion+'"  class="img-responsive" style="width: 100%;">'+
                        '<h1 class="title-head">'+titulo+'</h1>'+
                        '<br>'+
                        '<p style="color:  #000;" class="p1 justify">'+noticia+'</p>'+
                        '</div>'+
                        '</article>'+
                        '</div>'+
                        '</div>'+
