        ...
        <div class="header-media-wrap">
            <div class="header-media">
                ...
                <div class="carousel-inner">
                    ...
                    <img src="images/IMG-20160114-WA0043.jpg" alt="" style="width:100%">
                    </div>

                    <div class="item">
                    <img src="images/contacto.jpg" alt="" style="width:100%;">
                    </div>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
               ...
               <div class="banner-caption">
                    ...
                    <h1 id="h1-title"><em>Co</em>ntáctenos</h1>
                </div>
            </div>
        </div>
    ...
    <section id="section-body">
        <div class="container" style="width:100%;">
            <div class="col-sm-12  col-md-12" style="background: #fff">
                <div class="col-md-6 col-sm-6 col-lg-6" id="contact-bread-aling" style="padding: 0px 0px 0;">
            <div class="agileits_w3layouts-contact">
                <div   style="background: white;">
                    <div class="container" id="contact-aling" >
                        <div class=" w3_agileits-contact-left" >
                            <ul style="list-style:none;line-height: 40px;" id="contact">
                                <li><a href="tel:(031)6208801" data-toggle="modal" style="color:#000"><i class="fa fa-phone"></i> +571 6208801</a></li>
                                <li><a href="tel:+57 3112226222" data-toggle="modal" style="color:#000"><i class="fa fa-phone"></i> 3112226222</a></li>
                                <li><a href="tel:3112003333" target="_blank" style="color:#000"><i class="fa fa-phone"></i> 3112003333</a></li>
                             
                         
                                <li><a href="mailto:info@tutecho.net" style="color:#000"><i class="fa fa-envelope"></i> info@tutecho.net</a></li>
                                <li style="text-transform:none;"><i class="fa fa-map-marker"></i>  Ave.19 No. 118-95 Of.315</li>
                                <li><i class="fa fa-clock-o"></i> Horario: Lunes a Viernes de 8:00 am - 6:00 pm</li>
                                <li style="text-transform:  capitalize;"><i class="fa fa-map-marker"></i> Bogotá, Colombia</li>
                            </ul>
            ...
            <!-- //contact -->
            <!--map-->
            <div class="col-md-6 col-sm-6 col-lg-6" id="map-aling">
            
            
            <div class="map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3976.4018658582163!2d-74.04963265205163!3d4.700041853052721!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f9ab693d84057%3A0x8e31f230988b687e!2sOf.315%2C+Ak.+19+%23118-95%2C+Bogot%C3%A1!5e0!3m2!1ses-419!2sco!4v1541257812211" width="100%" height="330" frameborder="0" style="border:0" allowfullscreen></iframe>
                      </div>
